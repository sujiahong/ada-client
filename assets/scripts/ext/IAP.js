window.GLobleIAP = {
    ...
    init: function () {
        console.log('GLobleIAP init');
        if (this.hasSupport('getIAPPlugin')) {
            console.log('GLobleIAP exist iapplugin');
            this.iapPlugin = anysdk.agentManager.getIAPPlugin();
            if (this.iapPlugin) {
                console.log('GLobleIAP find iapplugin');
                this.iapPlugin.setListener(this.onIAPResult, this);
            } else {
                console.log('GLobleIAP can not find iapplugin');
            }
        } else {
            console.log('GLobleIAP does not exist iapplugin');
        }
    },
