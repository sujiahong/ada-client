...
var assetsManifest = path.join(assets, 'project.manifest');
var assetsVersion = path.join(assets, 'version.manifest');
...
fs.writeFile(assetsVersion, JSON.stringify(manifest), (err) => {
    if (err) throw err;
    console.log('Version successfully generated');
});
